...
public class HorizontalPodAutoscalerList implements KubernetesResource, KubernetesResourceList<io.fabric8.kubernetes.api.model.autoscaling.v2beta1.HorizontalPodAutoscaler>
{
    ...
    public List<io.fabric8.kubernetes.api.model.autoscaling.v2beta1.HorizontalPodAutoscaler> items = new ArrayList<io.fabric8.kubernetes.api.model.autoscaling.v2beta1.HorizontalPodAutoscaler>();
    /**
     * 
     * (Required)
     * 
