...
public class EndpointSliceList implements KubernetesResource, KubernetesResourceList<io.fabric8.kubernetes.api.model.discovery.v1beta1.EndpointSlice>
{
    ...
    public List<io.fabric8.kubernetes.api.model.discovery.v1beta1.EndpointSlice> items = new ArrayList<io.fabric8.kubernetes.api.model.discovery.v1beta1.EndpointSlice>();
    /**
     * 
     * (Required)
     * 
