...
/**
 * COPY&PASTE package protected .. from org.apache.hadoop.hdfs.tools.offlineImageViewer.PBImageTextWriter
 * 
 * 
...
abstract class PBImageTextWriter implements Closeable {
  ...
  protected SerialNumberManager.StringTable stringTable;
