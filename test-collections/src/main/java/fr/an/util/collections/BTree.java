...
public class BTree<T extends Comparable<T>> {
    ...
    // Default to 2-3 Tree
    private static final int minKeySize = 1;
    private static final int maxKeySize = 2 * minKeySize; // 2
    private static final int minChildrenSize = minKeySize + 1; // 2
    private static final int maxChildrenSize = maxKeySize + 1; // 3
...
//    }
    ...
    private static Comparator<Node<? extends Comparable<?>>> comparator = new Comparator<Node<? extends Comparable<?>>>() {
        @SuppressWarnings("rawtypes")
        @Override
        public int compare(Node<? extends Comparable<?>> arg0, Node<? extends Comparable<?>> arg1) {
            Comparable key0 = arg0.getKey(0);
            Comparable key1 = arg1.getKey(0);
