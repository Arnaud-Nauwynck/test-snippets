 ...
 * the <tt>Comparable</tt> interface and calls the <tt>compareTo()</tt> and
 * method to compare two keys. It does not call either <tt>equals()</tt> or
 * <tt>hashCode()</tt>. The <em>get</em>, <em>put</em>, and <em>contains</em>
