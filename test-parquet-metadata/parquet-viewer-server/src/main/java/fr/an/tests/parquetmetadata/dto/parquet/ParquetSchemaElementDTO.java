 ...
 * 
 * - if it is a group (inner node) then type is undefined and numChildren is defined 
 * - if it is a primitive type (leaf) then type is defined and numChildren is undefined 
...
public class ParquetSchemaElementDTO {
	 ...
	 * repetitionType. All other nodes must have one
	 */
	ParquetFieldRepetitionType repetitionType;
