...
public class Springboot3SparkWithRepackagedNoWebMain {

    public static void main(String[] args) {
        ClassLoader cl = Springboot3SparkWithRepackagedNoWebMain.class.getClassLoader();
        checkClassLoaderResource(cl, "javax/servlet/Servlet.class");

        SpringApplication.run(Springboot3SparkWithRepackagedNoWebMain.class, args);
    }
