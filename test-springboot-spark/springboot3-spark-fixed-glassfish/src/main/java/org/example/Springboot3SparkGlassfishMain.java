...
public class Springboot3SparkGlassfishMain {

    public static void main(String[] args) {
        ClassLoader cl = Springboot3SparkGlassfishMain.class.getClassLoader();
        checkClassLoaderResource(cl, "javax/servlet/Servlet.class");

        SpringApplication.run(Springboot3SparkGlassfishMain.class, args);
    }
