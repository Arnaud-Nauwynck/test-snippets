...
public class Springboot3SparkWithRepackagedServletAndGlassfishMain {

    public static void main(String[] args) {
        ClassLoader cl = Springboot3SparkWithRepackagedServletAndGlassfishMain.class.getClassLoader();
        checkClassLoaderResource(cl, "javax/servlet/Servlet.class");

        SpringApplication.run(Springboot3SparkWithRepackagedServletAndGlassfishMain.class, args);
    }
