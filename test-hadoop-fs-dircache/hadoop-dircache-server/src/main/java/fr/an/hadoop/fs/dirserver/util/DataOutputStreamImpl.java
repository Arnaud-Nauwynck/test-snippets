...
public final class DataOutputStreamImpl extends FilterOutputStream implements DataOutput {
	 ...
	 */
	public DataOutputStreamImpl(OutputStream out, long written) {
		super(out);
	...
	/**
	 * Writes the specified byte (the low eight bits of the argument <code>b</code>)
	 * to the underlying output stream. If no exception is thrown, the counter
	 ...
	 * high byte first. If no exception is thrown, the counter <code>written</code>
	 * is incremented by <code>2</code>.
	 *
	...
	/**
	 * Writes a <code>char</code> to the underlying output stream as a 2-byte value,
	 * high byte first. If no exception is thrown, the counter <code>written</code>
	 * is incremented by <code>2</code>.
	 *
	...
	/**
	 * Writes a <code>long</code> to the underlying output stream as eight bytes,
	 * high byte first. In no exception is thrown, the counter <code>written</code>
	 * is incremented by <code>8</code>.
	 *
	 ...
	 * writes that <code>long</code> value to the underlying output stream as an
	 * 8-byte quantity, high byte first. If no exception is thrown, the counter
	 ...
	 * <code>writeChar</code> method. If no exception is thrown, the counter
	 ...
	 * exception is thrown, the counter <code>written</code> is incremented by the
	 * total number of bytes written to the output stream. This will be at least two
	 * plus the length of <code>str</code>, and at most two plus thrice the length
	 * of <code>str</code>.
	 *
	 ...
	 * <code>str</code>, and at most two plus thrice the length of <code>str</code>.
	 *
	 * @param str a string to be written.
