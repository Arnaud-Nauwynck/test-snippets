...
public class SampleActiveMQApplication {
	...
	public JmsListenerContainerFactory<?> jmsListenerContainerTopic() {
		DefaultJmsListenerContainerFactory res = new DefaultJmsListenerContainerFactory();
		res.setPubSubDomain(true);
		res.setConnectionFactory(activeMQConnectionFactory);
		return res;
	}
